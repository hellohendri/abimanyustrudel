                ...
                <table class="table tableSort" style="width:100%" data-dom="ltrip">
                    <thead>
                        <tr data-sort-method='thead'>
                            ...
                            <th scope="col" class="d-none d-md-table-cell">HPP</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell"> {{$data->hpp}}</td>
                            <td class="d-none d-lg-table-cell"> {{$data->harga_jual}}</td>
                            <td class="d-none d-lg-table-cell">{{Str::limit(strip_tags($data["deskripsi"]), 50, "...")}}</td>
