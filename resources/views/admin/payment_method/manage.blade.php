            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="metode_pembayaran" name="metode_pembayaran" required="true" placeholder="Metode Pembayaran"  value="{{{ old('metode_pembayaran', isset($data)?$data->metode_pembayaran : '') }}}">
