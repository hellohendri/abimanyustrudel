            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="jenis_roti" class="col-md-2 col-form-label">Jenis Roti:*</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="jenis_roti" name="jenis_roti" required="true" placeholder="Jenis Roti"  value="{{{ old('jenis_roti', isset($data)?$data->jenis_roti : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('jenis_roti')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="jenis_roti_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
