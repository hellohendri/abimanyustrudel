            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="payment_status" name="payment_status"  placeholder="Payment Status"  value="{{{ old('payment_status', isset($data)?$data->payment_status : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('payment_status')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="payment_status_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
            </div>
